const {dbconn, dbstmt} = require('idb-connector');
 ...
 async function autotelexFiliaal (setletter, filiaal) {
	 
  return new Promise(function(resolve)
  {
 
 
    const sSql = 'SELECT * from dasfp'+setletter + '.atfiliaal where atfbran =' +filiaal;
...
function testen (jsonfile) {
 ...
 module.exports = {
  autotelexFiliaal: autotelexFiliaal,
 };
